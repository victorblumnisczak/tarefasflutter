    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          // A listagem já é atualizada pelo ViewModel após o cadastro
        },
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                color: product.favorite
                    ...
                    : null,
                // onTap navega para a tela de detalhes passando o produto selecionado
                child: ListTile(
                  onTap: () async {
                    await Navigator.push(
                      context,
                    ...
                    // A listagem já é atualizada pelo ViewModel após edit/delete
                  },
